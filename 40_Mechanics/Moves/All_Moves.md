...
When you encounter content flagged as something to approach mindfully, pause to consider or discuss its role in your story. When you come across flagged content that you would rather adjust or omit, [Change Your Fate](Change_Your_Fate.md).
...
**When you resolve a progress move or complete an intense scenario**, take a few deep breaths and take some time to attend to the needs of your body. Reflect on what just happened and how it made you feel. Then, choose one.
  ...
  * Stop for now: [End a Session](End_a_Session.md).
...
On a **miss**, you fail, or a momentary success is undermined by a dire turn of events. [Pay the Price](Pay_the_Price.md).
...
On a **miss**, you fail or your assumptions betray you. [Pay the Price](Pay_the_Price.md).
...
On a **weak hit**, as above, but there is more to be done or you realize the truth of your quest. If you [Swear an Iron Vow](Swear_an_Iron_Vow.md) to set things right, take your full legacy reward. Otherwise, make the reward one rank lower.

On a **miss**, your vow is undone through an unexpected complication or realization. Envision what happens and choose one.

  * Give up on the quest: [Forsake Your Vow](Forsake_Your_Vow.md).
...
On a **weak hit**, as above, but they ask something more of you first. To gain the bond and the legacy reward, envision the nature of the request, and do it (or [Swear an Iron Vow](Swear_an_Iron_Vow.md) to see it done).
...
On a **miss**, you are waylaid by a crisis, or arrive at a waypoint to confront an immediate hardship or threat. Do not mark progress, and [Pay the Price](Pay_the_Price.md).

### Explore a Waypoint

**When you divert from an expedition to examine a notable location**, roll +wits.

On a **strong hit**, choose one. On a **strong hit with a match**, you may instead [Make a Discovery](Make_a_Discovery.md).
...
On a **miss**, you encounter an immediate hardship or threat, and must [Pay the Price](Pay_the_Price.md). On a **miss with a match**, you may instead [Confront Chaos](Confront_Chaos.md).
...
On a **miss**, your destination is lost to you, or you come to understand the true nature or cost of the expedition. Envision what happens and choose one.
  ...
  * Abandon the expedition: Envision the cost of this setback and [Pay the Price](Pay_the_Price.md).
...
On a **miss**, your foe gains the upper hand, the fight moves to a new location, or you encounter a new peril. You are in a bad spot and must [Pay the Price](Pay_the_Price.md).
...
On a **miss**, the fight turns against you. You are in a bad spot and must [Pay the Price](Pay_the_Price.md).
...
On a **miss**, you are defeated or your objective is lost. [Pay the Price](Pay_the_Price.md).
...
On a **weak hit**, you achieve your objective, but not without cost. [Pay the Price](Pay_the_Price.md).

On a **miss**, you are defeated or the objective is lost. [Pay the Price](Pay_the_Price.md).

## Suffer Moves

When you bear the brunt of a failed action or make a concession, the suffer moves help resolve the cost. These moves are typically made when you must [Pay the Price](Pay_the_Price.md) and face a hardship that directly impacts your well-being and readiness, or as prompted by a move or asset.
...
**When your companion faces physical hardship**, they suffer -1 health for minor harm, -2 for serious harm, or -3 for major harm. If your companion's health is 0, [Lose Momentum](Lose_Momentum.md) equal to any remaining harm.
...
On a **weak hit**, if your companion's health is not 0, you may [Lose Momentum](Lose_Momentum.md) (-1) and give them +1 health. Otherwise, they press on.

On a **miss**, it's worse than you thought. They suffer an additional -1 health or you [Lose Momentum](Lose_Momentum.md) (-2). If your companion's health is 0, they are out of action until given aid. If their health is 0 and you rolled a miss with a match on this move, they are dead or destroyed; discard the asset.
...
On a **miss**, you encounter an unexpected peril. [Pay the Price](Pay_the_Price.md).
...
On a **weak hit**, choose one.
  ...
  * There is more to be done. Envision what is revealed or asked of you at death's door, and [Swear an Iron Vow](Swear_an_Iron_Vow.md) to complete an extreme quest. You return to the mortal world and must mark **doomed**. When you complete the deathbound quest, clear the impact.
...
On a **weak hit**, choose one.
  ...
  * You see a vision of a dreaded event coming to pass. Envision that dark future, and [Swear an Iron Vow](Swear_an_Iron_Vow.md) to prevent it through an extreme quest. You return to your senses and must mark **tormented**. When you complete the soul-bound quest, clear the impact.
...
On a **weak hit**, you owe someone. You must mark **indebted** and [Swear an Iron Vow](Swear_an_Iron_Vow.md) to complete an extreme quest in their service. When you complete the duty-bound quest, clear the impact.

On a **miss**, as with the weak hit result, but this quest is against your nature, forces you to [Forsake Your Vow](Forsake_Your_Vow.md) on another quest, or is in the service of an enemy.
...
For each **weak hit**, choose one from below, or one from the miss options.
  ...
  * See it through: Choose one of the former character's unfinished quests, and [Swear an Iron Vow](Swear_an_Iron_Vow.md) (with an automatic strong hit) to see it done. You may immediately mark up to half their earned progress (round down) on this quest.
...
**When you suffer the outcome of an action**, choose one.
  ...
  * [Ask the Oracle](Ask_the_Oracle.md) for inspiration. Interpret the answer as a hardship or complication appropriate to the situation.
...
When the clock is full, you must [Finish the Scene](Finish_the_Scene.md).
...
On a **miss**, you fail, or a momentary success is undermined by a dramatic turn of events. Fill a clock segment and [Pay the Price](Pay_the_Price.md). On a **miss with a match**, fill two segments and [Pay the Price](Pay_the_Price.md).
